		...
		<div class="card border-success mb-3 mt-3 formulario" style="max-width: 55rem;">
			...
			<form class="row" method="POST" action="admin-usuarios.php" style="margin: 0 5px;">
				...
				<div class="col-lg-6 col-md-6">
						...
						<input name="direccion" type="text" placeholder="Dirección" class="form-control" required=""> <br>
						<input name="telefono" type="number" placeholder="Teléfono" class="form-control" required=""> <br>
